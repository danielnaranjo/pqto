...
<html lang="en">
    ...
    <body class=" login">
        ...
        <div class="logo">
            <!-- <a href="/">
                <img src="<?php echo base_url()?>assets/pages/img/logo.png" alt="logo" />
            </a> -->
        </div>
        <!-- END LOGO -->
        <!-- BEGIN LOGIN -->
        <div class="content">
            ...
            <?php echo form_open('user/logon'); ?>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control form-control-solid placeholder-no-fix" type="text" autocomplete="off" placeholder="Username" name="email" id="email" value="daniel@loultimoenlaweb.com" /> </div>
                <div class="form-group">
                    <label class="control-label visible-ie8 visible-ie9">Password</label>
                    <input class="form-control form-control-solid placeholder-no-fix" type="password" autocomplete="off" placeholder="Password" name="password" id="password" value="2917532" /> </div>
        ...
        <div class="copyright"> 2016-<?=date('Y')?> &copy; Paqueto. Powered by loultimoenlaweb.com</div>
        <!--[if lt IE 9]>
